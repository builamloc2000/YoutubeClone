        ...
        const Header = () => {
          return (
            ...
            <div className="flex items-center pl-2 ">
                <svg className="w-6 h-6 mr-5">
                    <path d="M21 6H3V5h18v1zm0 5H3v1h18v-1zm0 6H3v1h18v-1z"></path>
                </svg>

                <div className="items-center flex ml-6">
                    <svg className="h-5 w-24">
                        <g>
                            <path
            ...
            <div className="flex w-3/5 h-10 justify-end items-center">
                <form action=""
                    ...
                    <div className="mr-3 ml-3"><img src="//www.gstatic.com/inputtools/images/tia.png" alt="keybroad"/></div>

                </form>
                <button id="search"><svg className="h-10 w-[67px] bg-slate-100 rounded-r-[25px] border border-gray-400">
                        <path className="h-6 w-6 translate-x-5 translate-y-[7px]"
                ...
                <div className="pl-4"><svg className="h-10 w-10 rounded-full bg-slate-100 ">
                        <path className="translate-x-2 translate-y-2"
            ...
            <div className="flex w-[7%] justify-between items-center ">
                ...
                <div id="createVideo"><svg className="w-6 h-6 mr-5">
                        <path
                ...
                <div className="relative">
                    ...
                    <div
                        className="absolute top-[-3px] right-3 rounded-full bg-red-700 text-[11px] text-white pl-[2px] pr-[2px]">
                        9+</div>
                </div>

                <img className="h-8 w-8 rounded-full"
                    src="https://yt3.ggpht.com/yti/ADpuP3OL_1yHZrnwjETzyJFFNNewNbyMM5obKbrvRQ=s88-c-k-c0x00ffffff-no-rj" alt="avatar"/>
